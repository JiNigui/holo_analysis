...
def main():
    ...
    unet_model_path = os.path.join(script_dir, 'unet.pth')
    maskrcnn_model_path = os.path.join(script_dir, 'maskrcnn_new.pth')
    input_folder = os.path.join(script_dir, '../../data/output_voi')
    output_folder = os.path.join(script_dir, '../../data/output_detections')
